...
public class CustomBlockData implements PersistentDataContainer {
   ...
   * when a player breaks this block. It will additionally call custom events like {@link vendored.com.jeff_media.customblockdata.events.CustomBlockDataRemoveEvent}.
  ...
  private static final class DataType {
    private static final PersistentDataType<Byte, Boolean> BOOLEAN =
        new PersistentDataType<Byte, Boolean>() {
          @NotNull @Override
